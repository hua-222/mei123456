	...
	<div class="box">
		<div class="banner">
			<mt-swipe :auto="4000">
				...
				<mt-swipe-item><img src="https://image1.guazistatic.com/qn1904122055431f64670fa1ce7de55b9d2558a7e29432.png?imageView2/2" alt=""></mt-swipe-item>
			</mt-swipe>
			</swipe>
		</div>
		<div class="main">
			<div class="mains">
				<div class="main-t">
					...
					<el-row :gutter="20" class="hosttext">
						<el-col :span="6">
							<div class="grid-content bg-purple" @click="getPtahs('p2')">3万以下</div>
						</el-col>
						<el-col :span="6">
							<div class="grid-content bg-purple" @click="getPtahs('p3')">3-5万</div>
						</el-col>
						<el-col :span="6">
							<div class="grid-content bg-purple" @click="getPtahs('p4')">5-7万</div>
						</el-col>
						<el-col :span="6">
							<div class="grid-content bg-purple" @click="getPtahs('p5')">7-9万</div>
						</el-col>
					</el-row>
					<HostCar></HostCar>
				</div>
...
<script>
	...
	export default {
				...
				bodys: [{
						...
						imgurl: {
							...
							bigurl: [
								...
								'https://image.guazistatic.com/gz01191124/16/48/fbffedd297ddcd21ab8f43f50e662c80.jpg@base@tag=imgScale&w=750&h=500&c=1&m=2&q=88'
							]
						},
						// 价格
						price: '45000',
		...
		methods: {
			getPtahs(p){
				this.getPtah(this.$router,p,'BuyCars')
			}
		},
		mounted() {
